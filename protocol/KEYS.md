...
| ---- | ------- | ------------- | -------------------------------- |
| 1    | Tier 1  | `aaa`         | Read-only                        |
| 2    | Tier 2  | `aaaa`        | Read/write                       |
| 3    | Tier 3  | `aaaaa`       | Full access + highest privileges |

Keys not matching any prefix are rejected. Generation requires ≥ 2 GB RAM.
...
| ----------- | ------ | --------------------------------- | ------------------------------------------------ |
| Public key  | `apub` | `apub<data><checksum>`            | `apub1...`, `aaa...`, `aaaa...`, `aaaaa...`, SPKI Base64, PEM |
